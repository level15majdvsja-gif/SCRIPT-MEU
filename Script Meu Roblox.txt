...
local Window = OrionLib:MakeWindow({Name = "Mini Drey Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Mini Drey Hub"})
...
W:AddLabel("[+] Mini Drey Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Mini Drey Hub(Noitification)",
